...
function create_parva_card(parva_idx)
{
    ...
    content += `<a style="float:left" href="/${parva_idx}/1.html" class="btn btn-sm btn-warning mx-1"><span class="fa fa-book"></span>&nbsp;Read</a>`;
    content += `<a style="float:right" href="/sanskrit/${parva_idx}/1.html" class="btn btn-sm btn-warning mx-1">कि&nbsp;Original</a>`;
    content += '</div></div></div>'
    return content;               
}
